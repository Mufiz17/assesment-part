                                ...
                                <div class="row row-cards">
                                    <div class="col-sm-4 col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control datepicker" placeholder="Masukan Tanggal" id="datepicker-icon-1" name="tanggal" autocomplete="off" value="{{ $tahfidz->tanggal }}">
                                        </div>
                                    </div>
                                    <div class="col-sm-4 col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control form-select" name="kelas">
                                                ...
                                                <option value="X" {{ $tahfidz->kelas == 'X' ? 'selected' : '' }}>X</option>
                                                <option value="XI" {{ $tahfidz->kelas == 'XI' ? 'selected' : '' }}>XI</option>
                                                <option value="XII" {{ $tahfidz->kelas == 'XII' ? 'selected' : '' }}>XII</option>
                                                <option value="XIII" {{ $tahfidz->kelas == 'XIII' ? 'selected' : '' }}>XIII</option>
                                            </select>
                                            @error('kelas')
