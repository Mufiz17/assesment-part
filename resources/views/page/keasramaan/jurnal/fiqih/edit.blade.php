                                ...
                                <div class="row row-cards">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control form-select" name="kelas">
                                            ...
                                            <option value="X" @if ($fiqih->kelas == 'X') selected @endif>X
                                            </option>
                                            <option value="XI" @if ($fiqih->kelas == 'XI') selected @endif>XI
                                            </option>
                                            <option value="XII" @if ($fiqih->kelas == 'XII') selected @endif>
                                                XII</option>
                                            <option value="XIII" @if ($fiqih->kelas == 'XIII') selected @endif>
                                                XIII</option>
                                        </select>
                                        @error('kelas')
                                            <div class="text-danger mt-2"> {{ $message }} </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type='text' class="form-control" name="nisn"
                                            placeholder="Masukan NISN Siswa" value="{{ $fiqih->nisn }}">
                                        @error('nisn')
                                            <div class="text-danger mt-2"> {{ $message }} </div>
                                        @enderror
                                    </div>
