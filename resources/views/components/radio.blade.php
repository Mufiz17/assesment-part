...
<div class="modal modal-blur fade" id="modalReport5" tabindex="-1" aria-hidden="true" style="display: none;">
    <form action="{{ route('notulensi.store') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Notulensi Rapat & Pelatihan Guru</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                <label class="form-label required">Narasumber</label>
                                    ...
                                    <tbody>
                                        @foreach ($suratkeluar as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <form action="{{ route('outbox.download', $item->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('GET')
                                                            <button type="submit"
                                    ...
                                    <tbody>
                                        @foreach ($nomorsurat as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <form action="{{ route('no_surat.download', $item->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('GET')
                                                            <button type="submit"
                                    ...
                                    <tbody>
                                        @foreach ($notulensi as $item)
                                            <tr>
                                                ...
                                                <td>{{ Str::limit($item->pemateri, 15) }}</td>
                                    ...
                                    <tbody>
                                        @foreach ($suratpengajuan as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <form action="{{ route('pengajuan.download', $item->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('GET')
                                                            <button type="submit"
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="pemateri"
                                        placeholder="Kolom wajib diisi" value="{{ old('pemateri', $item->pemateri) }}">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="mb-3">
