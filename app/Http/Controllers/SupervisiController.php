...
class SupervisiController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('page.supervisi.index', compact('supervisi', 'tahunAjaranOptions', 'tahunAjaranFilter'));
    }

    public function create()
    {
        return view('page.supervisi.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('page.supervisi.edit', compact('supervisi'));
    }
