...
class WakaKesiswaanController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('page.waka_kesiswaan.index', compact('wakaKesiswaan', 'tahunAjaranFilter', 'tahunAjaranOptions'));
    }

    public function create()
    {
        return view('page.waka_kesiswaan.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('page.waka_kesiswaan.edit', compact('wakaKesiswaan'));
    }
    ...
    public function exportPDF($id)
    {
        ...
        $pdf = PDF::loadView('page.waka_kesiswaan.pdf', compact('data'));
