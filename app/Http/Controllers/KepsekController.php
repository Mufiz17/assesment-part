...
class KepsekController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('page.kepsek.index', compact('kepsek', 'tahunAjaranOptions', 'tahunAjaranFilter'));
    }

    public function create()
    {
        return view('page.kepsek.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('page.kepsek.edit', compact('kepsek'));
    }
    ...
    public function exportPDF($id)
    {
        ...
        $pdf = FacadePdf::loadView('page.kepsek.pdf', compact('data'));
