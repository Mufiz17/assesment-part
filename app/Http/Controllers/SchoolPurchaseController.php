...
class SchoolPurchaseController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('page.admin.sekolah.index', compact('schoolPurchases'));
    }

    public function goodItems()
    {
        $schoolPurchases = SchoolPurchase::all();
        return view("page.admin.sekolah.goodItems", compact("schoolPurchases"));
    }

    public function damagedItems()
    {
        $schoolPurchases = SchoolPurchase::all();
        return view("page.admin.sekolah.damagedItems", compact("schoolPurchases"));
    }
    ...
    public function filterByYear(Request $request)
    {
        ...
        return view('page.admin.sekolah.index', compact('schoolPurchases', 'years'));
    }
    ...
    {
        $schoolPurchase = SchoolPurchase::findOrFail($id);
        return view("page.admin.sekolah.damagedItems", compact("schoolPurchase"));
    }
    ...
    {
        $schoolPurchases = SchoolPurchase::all();
        $pdf = Pdf::loadView('page.admin.sekolah.print', compact('schoolPurchases'));
        return $pdf->stream('Sarpras Sekolah.pdf');
    }
    public function pdf()
    {
        $schoolPurchases = SchoolPurchase::get();
        return view("page.admin.sekolah.print", compact("schoolPurchases"));
    }
