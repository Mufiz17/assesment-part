...
class PerpustakaanController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('page.perpustakaan.index', compact('perpustakaan', 'tahunAjaranOptions', 'tahunAjaranFilter'));
    }
    ...
    {
        return view('page.perpustakaan.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('page.perpustakaan.edit', compact('perpustakaan'));
    }
