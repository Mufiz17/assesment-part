...
class KepalaLabkomController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('page.kepalaLabKom.index', compact('kepalaLabKom', 'tahunAjaranFilter', 'tahunAjaranOptions'));
    }
    ...
    {
        return view('page.kepalaLabKom.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('page.kepalaLabKom.edit', compact('kepalaLabKom'));
    }
