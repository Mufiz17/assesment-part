...
class DormPurchaseController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('page.admin.asrama.index', compact('dormPurchases'));
    }
    public function goodItems()
    {
        $dormPurchases = DormPurchase::all();
        return view("page.admin.asrama.goodItems", compact("dormPurchases"));
    }
    public function damagedItems()
    {
        $dormPurchases = DormPurchase::all();
        return view("page.admin.asrama.damagedItems", compact("dormPurchases"));
    }
    ...
    {
        $dormPurchase = DormPurchase::findOrFail($id);
        return view("page.admin.asrama.damagedItems", compact("dormPurchase"));
    }
    ...
    {
        $dormPurchases = DormPurchase::all();
        $pdf = Pdf::loadView('page.admin.asrama.print', compact('dormPurchases'));
        return $pdf->stream('Sarpras Asrama.pdf');
    }
    public function pdf()
    {
        $dormPurchases = DormPurchase::get();
        return view("page.admin.asrama.print", compact("dormPurchases"));
    }
